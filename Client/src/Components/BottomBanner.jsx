...
import { assets, features } from '../assets/grocygoassets/assets'

function BottomBanner() {
  return (
    <div className='relative mt-24'>

<img src={assets.bottom_banner_image} alt="bannner" className='w-full hidden md:block'/>
<img src={assets.bottom_banner_image_sm} alt="bannner" className='w-full  md:hidden'/>
...
<div>
<h3 className='text-lg mid:text-xl font-semibold'>{feature.title}</h3>
