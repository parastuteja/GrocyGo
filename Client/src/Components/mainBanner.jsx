...
function MainBanner() {
  return (
    <div className='relative'>
        ...
        Shop Now
        <img className='md:hidden transition group-focus:translate-x-1 white-arrow-icon' alt="arrow"/>
        </Link>
          <Link to={'/products'} className='group hidden md:flex items-center gap-2  px-9 py-3 bg-primary hover:bg-primary-dull transition
        rounded text-white cursor-pointer'>Explore Deals
