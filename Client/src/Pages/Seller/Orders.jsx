...
import { assets, dummyAddress, dummyOrders } from '../../assets/grocygoassets/assets';
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col  md:items-center  md:flex-row gap-5  justify-between p-5 max-w-4xl rounded-md border border-gray-300">
                    ...
                    <div className="text-sm md:text-base text-black/60">
                        ...
                        <p>{order.address.street}, {order.address.city}, {order.address.state}</p><p>{order.address.zipcode}, {order.address.country}</p>
                        <p></p>
                        <p>
                          {order.address.phone}
                        </p>
                    ...
                    <div className="flex flex-col text-sm .d:text-base text-black/60">
